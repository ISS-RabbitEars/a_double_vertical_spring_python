...
def integrate(ic, ti, p):
	y1, v1, y2, v2 = ic
	m1, m2, k1, k2, yeq1, yeq2, gc = p

	print(ti)

	return [v1, AY1.subs({M1:m1, K1:k1, K2:k2, YEQ1:yeq1, YEQ2:yeq2, g:gc, Y1:y1, Y2:y2}),\
		v2, AY2.subs({M2:m2, K2:k2, YEQ2:yeq2, g:gc, Y1:y1, Y2:y2})]
...
dL1 = ddtdLdY1dot - dLdY1
dL2 = ddtdLdY2dot - dLdY2
